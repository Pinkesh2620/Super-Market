...
if (!isset($_SESSION['login'])) {
    echo '<div class="icons"><a href="registration.php"><div class="fa fa-user-plus"   id="logout-btn"></div></a></div>';
    echo '<div class="icons"><a href="login.php"><div class="fa fa-sign-in" id="logout-btn"></div></a></div>';
} else {
    echo '<div class="icons"><a href="accountinfo.php"><div class="fa fa-user" id="login-btn"></div></a></div>';
    echo '<div class="icons"><a href="#" onclick="logout()"><div class="fa fa-sign-out-alt" id="logout-btn"></div></a></div>';
}
?>
    ...
    <section class="home" id="home">
        <div class="content">
            ...
            <p>Indulge in the pure goodness of our fresh and organic products, meticulously curated to bring nature's finest to your table. Sourced from local farmers who prioritize sustainable and ethical practices, our selection boasts a vibrant array of fruits, vegetables, and other wholesome delights. Each bite is a celebration of flavor, nutrition, and the commitment to a healthier, more sustainable lifestyle.
            </p>
    ...
    <section class="features" id="features">
        ...
        <div class="box-container">
            <div class="box">
                ...
                <p>Indulge in the pure goodness of our fresh and organic products, meticulously curated</p>
            ...
            <div class="box">
                ...
                <p>Experience the convenience of lightning-fast delivery with our service. We understand the importance of time, and that's why we pride ourselves on our swift and efficient delivery system. </p>
            ...
            <div class="box">
                ...
                <p>"Simplify your shopping experience with our easy payment options. We offer a hassle-free and secure payment process designed for your convenience. From credit and debit cards to digital wallets, choose the payment method that suits you best.</p>
    ...
    <section class="footer">
        <div class="box-container">
            <div class="box">
                <h3>Dwarkesh Super Market<i class="fa fa-shopping-basket"></i></h3>
                <p>Here You will get best services and fresh fruits,vegetables and Dairy Products
                </p>
